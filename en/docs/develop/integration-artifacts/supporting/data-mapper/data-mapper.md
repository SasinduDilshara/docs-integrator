...
| Bootstrap a complex mapping quickly | **Auto Map** in the data mapper view ([Map with AI](./mapping-capabilities.md#map-with-ai)) or [AI data mapping](./ai-mapping.md) for large schemas |
