...
- [Bind Tools to Agents](/docs/genai/agents/tool-binding) — Give agents access to external services and data
- [Agent Architecture & Concepts](/docs/genai/agents/architecture-concepts) — Review how memory fits into the agent loop
- [Create a Chat Agent](/docs/genai/agents/chat-agents) — Build a complete chat agent with memory configured
